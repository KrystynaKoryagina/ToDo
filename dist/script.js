...
/* harmony import */ var _modules_todo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/todo */ "./src/js/modules/todo.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = new _modules_tabs__WEBPACK_IMPORTED_MODULE_0__["Tabs"]({
    container: '.js-todoTabs',
    buttons: '.js-todoTabsButton',
    items: '.js-todoTabsItem'
  });
  tabs.init();
  var todos = new _modules_todo__WEBPACK_IMPORTED_MODULE_1__["Todo"]('.js-todoList');
  todos.init();
  var addForm = new _modules_form__WEBPACK_IMPORTED_MODULE_2__["AddForm"]('.js-addForm');
  addForm.init();
  addForm.addNewTask = todos.addTask.bind(todos);
  var searchForm = new _modules_form__WEBPACK_IMPORTED_MODULE_2__["SearchForm"]('.js-searchForm');
  searchForm.init();
...
/*!********************************!*\
  !*** ./src/js/modules/form.js ***!
  \********************************/
/*! exports provided: AddForm, SearchForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    key: "checkInputs",
    value: function checkInputs(_ref) {
    ...
    value: function init() {
      ...
      this.formInputs.forEach(function (input) {
        input.addEventListener('input', _this.checkInputs.bind(_this));
      });
    }
  }]);
...
var AddForm = /*#__PURE__*/function (_Form) {
  ...
  function AddForm(formName) {
    ...
    _this2 = _super.call(this, formName);
    _this2.addNewTask = null;

    _this2.form.addEventListener('submit', _this2.onAddTaskFormHandler.bind(_assertThisInitialized(_this2)));

    return _this2;
  }

  _createClass(AddForm, [{
    key: "onAddTaskFormHandler",
    value: function onAddTaskFormHandler(e) {
      e.preventDefault();
      var taskData = {
        id: Date.now(),
...
var SearchForm = /*#__PURE__*/function (_Form2) {
  _inherits(SearchForm, _Form2);
  ...
  function SearchForm(formName) {
    ...
    _this3 = _super2.call(this, formName);
    _this3.clearInputButton = _this3.form.querySelector('.js-clearInputButton');
    _this3.searchTask = null;

    _this3.clearInputButton.addEventListener('click', _this3.onClearInputClickHandler.bind(_assertThisInitialized(_this3)));

    _this3.form.addEventListener('submit', _this3.onSearchTaskFormHandler.bind(_assertThisInitialized(_this3)));

    return _this3;
  }

  _createClass(SearchForm, [{
    key: "onClearInputClickHandler",
    value: function onClearInputClickHandler() {
      Array.from(this.formInputs).map(function (input) {
        return input.value = '';
      });
    }
  }, {
    key: "onSearchTaskFormHandler",
    value: function onSearchTaskFormHandler(e) {
      e.preventDefault();
      var searchValue = this.formInputs.search.value.trim();
...
var Loader = /*#__PURE__*/function () {
  ...
  _createClass(Loader, [{
    key: "createLoaderTemplate",
    value: function createLoaderTemplate() {
...
;
var loader = new Loader('.js-todoList');
...
var Tabs = /*#__PURE__*/function () {
  ...
  _createClass(Tabs, [{
    ...
    key: "getCurrentButtonIndex",
    value: function getCurrentButtonIndex(element) {
      return Array.from(this.buttons).findIndex(function (button) {
        return button === element;
      });
    }
  }, {
    key: "onTabsClickHandler",
    value: function onTabsClickHandler(_ref2) {
      var target = _ref2.target;

      if (target.matches('.js-todoTabsButton')) {
        var buttonIndex = this.getCurrentButtonIndex(target);
        this.hideTabs();
...
/*!********************************!*\
  !*** ./src/js/modules/todo.js ***!
  \********************************/
/*! exports provided: TODO_STATUS, Todo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TODO_STATUS", function() { return TODO_STATUS; });
...
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/es.number.constructor */ "./node_modules/core-js/modules/es.number.constructor.js");
...
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./loader */ "./src/js/modules/loader.js");
...
var Todo = /*#__PURE__*/function () {
  ...
  _createClass(Todo, [{
    ...
    key: "doneTask",
    value: function doneTask(taskId) {
      this.setStatus(taskId, TODO_STATUS.done);
      this.setTimer(this.renderTaskList.bind(this, this.todos), 500);
    }
  }, {
    key: "holdTask",
    value: function holdTask(taskId) {
      var task = this.getTaskById(taskId);
      this.hasStatus(task, TODO_STATUS.hold) ? this.setStatus(taskId, TODO_STATUS.pending) : this.setStatus(taskId, TODO_STATUS.hold);
      this.setTimer(this.renderTaskList.bind(this, this.todos), 500);
    }
  }, {
    key: "editTask",
    value: function editTask(taskItem, taskId) {
      var task = this.getTaskById(taskId);
      taskItem.replaceWith(this.createTaskEditTemplate(task));
    }
  }, {
    key: "saveTask",
    value: function saveTask(taskItem, taskId) {
      var task = this.getTaskById(taskId);
    ...
    key: "searchTasks",
    value: function searchTasks(value) {
      var filterTasks = this.todos.filter(function (todo) {
        return todo.title.toLowerCase().startsWith(value.toLowerCase());
      });
      this.setTimer(this.renderTaskList.bind(this, filterTasks), 500);
    }
  }, {
    key: "setStatus",
    value: function setStatus(taskId, status) {
      var task = this.getTaskById(taskId);
      task.status = status;
    }
  }, {
    key: "hasStatus",
    value: function hasStatus(task, status) {
    ...
    key: "setStatusToAll",
    value: function setStatusToAll(status) {
      this.todos.forEach(function (todo) {
        return todo.status = status;
      });
    }
  }, {
    key: "sortTasksByTitle",
    value: function sortTasksByTitle() {
      var cloneTodos = _toConsumableArray(this.todos);

      return cloneTodos.sort(function (todoA, todoB) {
        return todoA.title.toLowerCase() > todoB.title.toLowerCase() ? 1 : -1;
      });
    }
  }, {
    key: "sortByStatus",
    value: function sortByStatus() {
      var sortTasks = this.sortTasksByTitle();
      return [].concat(_toConsumableArray(sortTasks.filter(function (task) {
        return task.status === TODO_STATUS.pending;
      })), _toConsumableArray(sortTasks.filter(function (task) {
        return task.status === TODO_STATUS.hold;
      })), _toConsumableArray(sortTasks.filter(function (task) {
        return task.status === TODO_STATUS.done;
      })));
    }
  }, {
    key: "showTaskActionsTrigger",
    value: function showTaskActionsTrigger() {
      this.taskActions.classList.add('todo__actions--active');
    }
  }, {
    key: "hideTaskActionsTrigger",
    value: function hideTaskActionsTrigger() {
      this.taskActions.classList.remove('todo__actions--active');
    }
  }, {
    key: "createTaskTemplate",
    value: function createTaskTemplate(task) {
      var taskItem = document.createElement('li');
      taskItem.classList.add('todo__item');
      taskItem.dataset.id = "".concat(task.id);
      var card = "\n\t\t\t<div class=\"card\">\n\t\t\t\t<div class=\"card__status card__status--".concat(task.status.toLowerCase(), "\">").concat(task.status, "</div>\n\t\t\t\t<div class=\"card__title\">").concat(task.title, "</div>\n\t\t\t\t<p class=\"card__description\">").concat(task.description, "</p>\n\t\t\t\t<div class=\"card__control\">\n\t\t\t\t\t<div class=\"btn-group btn-group--row\">\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoEditButton\" ").concat(this.hasStatus(task, TODO_STATUS.pending) ? '' : 'disabled', ">Edit</button>\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoHoldButton\" ").concat(this.hasStatus(task, TODO_STATUS.pending) ? '' : this.hasStatus(task, TODO_STATUS.hold) ? '' : 'disabled', ">").concat(this.hasStatus(task, TODO_STATUS.hold) ? 'Unhold' : 'Hold', "</button>\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoDoneButton\" ").concat(this.hasStatus(task, TODO_STATUS.pending) ? '' : 'disabled', ">Done</button>\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoDeleteButton\" ").concat(this.hasStatus(task, TODO_STATUS.pending) ? '' : this.hasStatus(task, TODO_STATUS.done) ? '' : 'disabled', ">Delete</button>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t");
      taskItem.insertAdjacentHTML('beforeend', card);
      return taskItem;
    }
  }, {
    key: "createTaskEditTemplate",
    value: function createTaskEditTemplate(task) {
      var taskItem = document.createElement('li');
      taskItem.classList.add('todo__item');
      taskItem.dataset.id = "".concat(task.id);
      var card = "\n\t\t\t<div class=\"card\">\n\t\t\t\t<div class=\"card__status card__status--".concat(task.status.toLowerCase(), "\">").concat(task.status, "</div>\n\t\t\t\t<form name=\"edit-task\" class=\"form form--no-padding\">\n\t\t\t\t\t<div class=\"form__group\">\n\t\t\t\t\t\t<input name=\"title\" id=\"todo-title\" type=\"text\" class=\"form__control js-todoTitleInput\" autocomplete=\"off\" value=\"").concat(task.title, "\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<textarea name=\"description\" id=\"todo-description\" class=\"form__control js-todoDescriptionInput\">").concat(task.description, "</textarea>\n\t\t\t\t</form>\n\t\t\t\t<div class=\"card__control\">\n\t\t\t\t\t<div class=\"btn-group btn-group--row\">\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoSaveButton\">Save</button>\n\t\t\t\t\t\t<button class=\"btn btn--xs js-todoCancelButton\">Cancel</button>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t");
      taskItem.insertAdjacentHTML('beforeend', card);
      return taskItem;
    }
  }, {
    key: "createMessageTemplate",
    value: function createMessageTemplate() {
      return "\n\t\t\t<li class=\"todo__item\">Your task list is empty!</li>\n\t\t";
    }
  }, {
    key: "getTaskListTemplate",
    value: function getTaskListTemplate(tasks) {
      var _this = this;

      var taskList = [];
      tasks.map(function (task) {
        var taskTemplate = _this.createTaskTemplate(task);
    ...
    value: function renderTaskList(tasks) {
      ...
      if (tasks.length) {
        ...
        var taskListTempalte = this.getTaskListTemplate(tasks);

        (_this$taskList = this.taskList).append.apply(_this$taskList, _toConsumableArray(taskListTempalte));
      } else {
    ...
    key: "setTimer",
    value: function setTimer(callback, delay) {
      _loader__WEBPACK_IMPORTED_MODULE_21__["loader"].setLoader();
      setTimeout(function () {
        _loader__WEBPACK_IMPORTED_MODULE_21__["loader"].removeLoader();
        callback();
      }, delay);
    }
  }, {
    key: "bulkActionsHandler",
    value: function bulkActionsHandler(target) {
    ...
    key: "sortActionsHandler",
    value: function sortActionsHandler(target) {
      var sortTasks = [];
    ...
    key: "onTaskActionsClickHandler",
    value: function onTaskActionsClickHandler(_ref) {
      var target = _ref.target;
    ...
    key: "onTaskListClickHandler",
    value: function onTaskListClickHandler(_ref2) {
      var target = _ref2.target;
      var taskItem = target.closest('.todo__item'),
